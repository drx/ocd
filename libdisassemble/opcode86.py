...
#( 0, INSTR_PREFIX, ARG_NONE, ARG_NONE, ARG_NONE, cpu_80386, 0, 0, 0, 0),  
#( 0, INSTR_PREFIX, ARG_NONE, ARG_NONE, ARG_NONE, cpu_80386, 0, 0, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 0 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 1 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 2 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 3 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 4 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 5 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 6 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_INC | INSTR_PREFIX64, OP_REG | OP_R, ARG_NONE, ARG_NONE, cpu_80386, "inc", 7 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 0 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 1 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 2 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 3 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 4 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 5 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 6 + REG_DWORD_OFFSET, 0, 0),  
( 0, INS_DEC | INSTR_PREFIX64, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_80386, "dec", 7 + REG_DWORD_OFFSET, 0, 0),  
...
( 0, INS_SHL, ADDRMETH_E | OPTYPE_v | OP_W, ADDRMETH_G | OPTYPE_v | OP_R, OP_R | OP_REG, cpu_80386, "shld", 0, 0, 1 + REG_BYTE_OFFSET), 
(0, 0, ARG_NONE, ARG_NONE, ARG_NONE, 0, 0, 0, 0, 0),  
(0, 0, ARG_NONE, ARG_NONE, ARG_NONE, 0, 0, 0, 0, 0),  
...
( 0, INS_SHR, ADDRMETH_E | OPTYPE_v | OP_W, ADDRMETH_G | OPTYPE_v | OP_R, OP_R | OP_REG, cpu_80386, "shrd", 0, 0, 1 + REG_BYTE_OFFSET), 
...
( 0, INS_SYSTEM, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_PENTIUM2, "prefetch", 0 + REG_TEST_OFFSET, 0, 0),  
( 0, INS_SYSTEM, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_PENTIUM2, "prefetch", 1 + REG_TEST_OFFSET, 0, 0),  
( 0, INS_SYSTEM, OP_REG | OP_W, ARG_NONE, ARG_NONE, cpu_PENTIUM2, "prefetch", 2 + REG_TEST_OFFSET, 0, 0),  
...
(tbl32_fpuD8_rest,3,0x07,0xc0,0xff),     #27
(tbl32_fpuD9_00BF,3,0x07,0,0xbf, 29),    #28
(tbl32_fpuD9_rest,3,0x07,0xc0,0xff),     #29
(tbl32_fpuDA_00BF,3,0x07,0,0xbf, 31),    #30
(tbl32_fpuDA_rest,3,0x07,0xc0,0xff),     #31
(tbl32_fpuDB_00BF,3,0x07,0,0xbf, 33),    #32
(tbl32_fpuDB_rest,3,0x07,0xc0,0xff),     #33
(tbl32_fpuDC_00BF,3,0x07,0,0xbf, 35),    #34
(tbl32_fpuDC_rest,3,0x07,0xc0,0xff),     #35
(tbl32_fpuDD_00BF,3,0x07,0,0xbf, 37),    #36
(tbl32_fpuDD_rest,3,0x07,0xc0,0xff),     #37
(tbl32_fpuDE_00BF,3,0x07,0,0xbf, 39),    #38
(tbl32_fpuDE_rest,3,0x07,0xc0,0xff),     #39
(tbl32_fpuDF_00BF,3,0x07,0,0xbf, 41),    #40
(tbl32_fpuDF_rest,3,0x07,0xc0,0xff),     #41
...
prefix_table = {
    ...
    0x40: PREFIX_REX,
    0x41: PREFIX_REX | PREFIX_REXB,
    0x42: PREFIX_REX | PREFIX_REXX,
    0x43: PREFIX_REX | PREFIX_REXB | PREFIX_REXX,
    0x44: PREFIX_REX | PREFIX_REXR,
    0x45: PREFIX_REX | PREFIX_REXB | PREFIX_REXR,
    0x46: PREFIX_REX | PREFIX_REXX | PREFIX_REXR,
    0x47: PREFIX_REX | PREFIX_REXB | PREFIX_REXX | PREFIX_REXR,
    0x48: PREFIX_REX | PREFIX_REXW,
    0x49: PREFIX_REX | PREFIX_REXB | PREFIX_REXW,
    0x4a: PREFIX_REX | PREFIX_REXX | PREFIX_REXW,
    0x4b: PREFIX_REX | PREFIX_REXB | PREFIX_REXX | PREFIX_REXW,
    0x4c: PREFIX_REX | PREFIX_REXR | PREFIX_REXW,
    0x4d: PREFIX_REX | PREFIX_REXB | PREFIX_REXR | PREFIX_REXW,
    0x4e: PREFIX_REX | PREFIX_REXX | PREFIX_REXR | PREFIX_REXW,
    0x4f: PREFIX_REX | PREFIX_REXB | PREFIX_REXX | PREFIX_REXR | PREFIX_REXW,
    0:    0
}
